                ...
                <div class="information">
                    ...
                    <form action="?module=cart&action=confirm" method="post">
                        <div class="form-group float-lert">
                            ...
                            <input type="text" name="fullName" placeholder="Nhập họ và tên" value="<?php if (isset($_SESSION['user']['fullname'])) {
                                        echo ($_SESSION['user']['fullname']);
                                    } ?>" required />
                        </div>
                        <div class="form-group float-lert">
                            <label for="">Email <span class="unique">*</span></label>
                            <input type="email" name="mail" value="<?php if (isset($_SESSION['user']['email'])) {
                                        echo ($_SESSION['user']['email']);
                                    } ?>" placeholder="Nhập email" required />
                        </div>
                        <div class="form-group float-lert">
                            <label for="">Số Điện Thoại <span class="unique">*</span></label>
                            <input type="text" name="phone" value="<?php if (isset($_SESSION['user']['phone'])) {
                                        echo ($_SESSION['user']['phone']);
                                    } ?>" placeholder="Nhập số điện thoại" required />
                        </div>
                        <div class="form-group float-lert">
                            <label for="">Địa Chỉ Chi Tiết <span class="unique">*</span></label>
                            <input type="text" name="adress" value="<?php if (isset($_SESSION['user']['adress'])) {
