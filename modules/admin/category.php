            ...
            <?php 
                                      // them du lieu 
                                        ...
                                        // update dữ liệu
                                            ...
                                            $tmp_name = $_FILES['fileCategory']['tmp_name'];
                                            if (!empty($nameIMG)){
                                                $result = $conn->query("UPDATE category SET nameCategory='".$nameCategory ."',image='".$nameIMG."', id_size = ".$idSize." WHERE id = '".$idCategory."'");
                                                move_uploaded_file($tmp_name, _WEB_PATH_TEMPLATE."/images/". $nameIMG);
                                            }else{
            ...
            <form id="form__show__list" action="" method="post">
                <div class="show__list">
                    ...
                    <div class="manage__category">
                        ...
                        <div class="bnt__chooseAll">
                            <button class="bnt__category" name="bntDeletechoose" onclick="return confirmDelete()">Xóa
