            ...
            while ($row = $result->fetch_assoc()) {
              ...
              <div class="tab__feedback-content-item">
                <div class="tab__feedback-user">
                  <img src="<?php echo _WEB_HOST_TEMPLATE ?>/images/avata/<?php echo $row['image']; ?>" alt="">
      ...
      <div class="tab__group tab__share">
        ...
        <div class="socialNetwork">
          ...
          <div class="show__socialNetwork">
            ...
            <div class="zalo-share-button" data-href="<?php echo getCurURL(); ?>" data-oaid="579745863508352884"
              data-layout="4" data-color="blue" data-customize=false></div>
          </div>
        </div>
      </div>
    </div>
